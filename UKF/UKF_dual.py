'''
UKF implementations for Dual Estimation
...
from .UKF_dual_utilities import additive_unscented_filter_dual
...
class UnscentedMixin(object):
    ...
    '''
     ...
     def filter(self, Y, noise_parameter):
        ...
        (filtered_state_means, filtered_state_covariances, filtered_params_means, filtered_params_covariances) = (
